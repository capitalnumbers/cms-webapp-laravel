...
$upload_dir = '/laravel/local/storage/uploads/image/'; // path from base_url to upload base dir
$current_path = '../../../../../storage/uploads/image'; // relative path from filemanager folder to upload files folder
...
//if you d on't have limit set both to 0
$image_max_width=0;
$image_max_height=0;
